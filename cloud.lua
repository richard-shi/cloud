...
function cloud.getCloud(radius, color, circleCount)
  ...
  -- Generate circle
  circleImage = cloud.radialGradient(circleRadius, color.r, color.g, color.b)
